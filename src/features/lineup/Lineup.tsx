...
const Lineup = ({ artists }: Props) => {
    ...
    return (
        <div className={styles.lineupContainer} ref={lineupRef} onTouchStart={stopAnimation} onClick={stopAnimation}>
            <div className={styles.lineup} onTouchStart={stopAnimation} onDrag={stopAnimation}>
                {artists.map((artist) => (
